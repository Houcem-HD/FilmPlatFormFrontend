...
const EditRealisateur = () => {
  // Meta title
  document.title = "Edit Realisateur | Skote - Vite React Admin & Dashboard Template";
  ...
  useEffect(() => {
    const fetchRealisateur = async () => {
      try {
        const response = await axios.get(`realisateur/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`realisateur/${id}`, {
        nom: name,
      });
