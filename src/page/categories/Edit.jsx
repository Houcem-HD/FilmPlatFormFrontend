...
import { Container, Row, Col, Card, CardBody, CardTitle, Label, Input, Button } from "reactstrap"; // Importing UI components
...
const EditCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`categorie/${id}`, category);
